    ...
    <div class="container-fluid" id="information-area">
        <div class="row">
            ...
            for ($i=0; $i<1 ; $i++) { 
                ...
                <p class='There_are_many_variations_of_passages'><?php  echo $txt_dizi_title[0];?></p>
                <p class='There_are_many_variations_of_passages' ><?php  echo $txt_dizi_about[0];?></p>
    ...
    <div class="container-fluid" id='email_template'>
        <div class="row">
            ...
            ?>
                ...
                <p class='text-center best_business_email_template'><?php  echo $txt_dizi_title[0];?></p>
                <div class='div_template'>
                    <p style='color:white;' class='text-center template_about'><?php  echo $txt_dizi_about[0];?></p>
                </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <p class='text-center satisfection_ptag1'><?php  echo $txt_dizi_title[0];?></p>
                <p class='text-center  satisfection_ptag2'><?php  echo $txt_dizi_about[0];?></p>
