...
$db_id = $row[$i]['id'];
  ...
  <tr>
      ...
      <td  class='kate'>$veriler</td>
      <td id='kate1'><a href='editors.php?id=$db_id'><i class='fa fa-edit'  style='font-size:30px;cursor:pointer'></i></a></td>
      <td><i class='fa fa-trash-o' style='font-size:30px;color:red;margin-bottom:3px;cursor:pointer' onclick='delete_text($db_id)'></i></td>
    </tr>
