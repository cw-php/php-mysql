...
<div class='islem-imgs'>
    <img src='resimler/upload.png'  onclick='resmiGuncelle($db_id)' id='$db_id' class='upload-img'>
    <img src='resimler/rubbish-bin.png' onclick='delete_img($db_id)' class='one' id='test'>
</div>
