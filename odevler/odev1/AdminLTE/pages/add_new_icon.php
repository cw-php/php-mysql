...
<p style='color:red'class='icon_bilgi'>İconları güncelle ve ya değiştirirken önünde olan fa kelimesini kullanmayınız</p>
...
<input type='text' value='' placeholder='İcon Adı' name='name'><br>
<input type='text' value='' placeholder='İcon Kodu' name='code'><br>
<input type='text' value='' placeholder='İcon Linki' name='link'><br>
<input type='submit' class='submit' name='gonder' value='Güncelle'>
