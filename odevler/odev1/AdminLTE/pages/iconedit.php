...
<input type='text' value=<?php echo $code; ?> name='code'><br>
<input type='text' value=<?php echo $link; ?> name='link'><br>
...
if(isset($_POST['name'])){
    ...
    $sql2="UPDATE `icons` set `icon_name`='$new_name',`icon_code`='$new_code',`icon_link`='$new_link' where `id`=$id";
