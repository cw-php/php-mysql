        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form method='post'>
              <h3 style='display:inline-block;margin-right:10px;'> Başlık : </h3><input style='width:400px;height:30px;margin-top:-40px;' value='' class='titles' name='title' type='text' autocomplete='off'>
              <select class='select' name='text_place'>
